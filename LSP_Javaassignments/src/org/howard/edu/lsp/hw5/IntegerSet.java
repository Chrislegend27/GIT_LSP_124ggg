...
// Set union
	public IntegerSet union(IntegerSet intSetb) {
	    IntegerSet result = new IntegerSet(); // Create a new IntegerSet to hold the union
	    
	    // Add all elements from the current set to the result set
	    result.set.addAll(this.set);
	    
	    // Add elements from intSetb that are not already in the result set
	...
	public IntegerSet intersect(IntegerSet intSetb) {
	    ...
	    // Retain only the common elements between the current set and intSetb
	    result.set.addAll(this.set);
